...
export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="pulse-glow group fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-whatsapp text-whatsapp-foreground shadow-xl transition-all duration-300 hover:scale-110 hover:bg-whatsapp-glow md:bottom-8 md:right-8 md:h-16 md:w-16"
    >
